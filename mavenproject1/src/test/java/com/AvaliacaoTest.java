...
public class AvaliacaoTest {
        ...
        public void testAvaliacaoConstructorGettersAndSetters() {
                ...
                Avaliacao avaliacao = new Avaliacao(institution, schoolSubject, educatorName, testsNumber,
                                questionsList);
        ...
        public void testGenerateFileCreatesFiles() {
                // Setup
                Avaliacao avaliacao = new Avaliacao("Test Institution", "Math", "Mr. Smith", 3, new ArrayList<>());
                String directory = "C:\\Users\\Alyssandro\\Documents";
                new File(directory).mkdirs(); // Ensure directory exists

                // Act
                avaliacao.generateFile(new ArrayList<>(), directory, 1);
